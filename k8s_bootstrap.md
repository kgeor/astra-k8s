...
+ 3 чистые ВМ с Astra Linux 1.8 (мастер-узлу выделите 2 ядра цп/3гб ОЗУ, остальным 2/2)
+ Доступ к ним по SSH для Ansible
+ Ansible на хостовой ВМ (или можно установить его на выделенную под мастер ВМ) для запуска сценария, подготавливающего узлы кластера.
